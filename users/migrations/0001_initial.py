    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("vk_link", models.URLField(blank=True, null=True, verbose_name="ВК ссылка"),),
                ("vk_id", models.IntegerField(blank=True, null=True, verbose_name="ВК ID"),),
                ("eco_balance", models.IntegerField(default=0, verbose_name="Эко-баллы"),),
                ("is_department", models.BooleanField(default=False, verbose_name="Сотрудник департамента"),),
                (
                    "groups",
